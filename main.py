...
#     try:
#         #user_message = event['text'].replace(f'<@{os.getenv("SLACK_BOT_USER_ID")}>', '').strip()
...
#             model="gpt-3.5-turbo",
#             messages=[
#                 {"role": "system", "content": "You are an AI assistant, so answer my queries in a good and concise way."},
...
#                 model="gpt-3.5-turbo",
#                 messages=[
#                     {"role": "system", "content": "You are an AI assistant for an email marketing agency."},
